function correlation_coeff = IBS_compute_corresp_vicon_manipulated_video(Dyad_no,Sub_no,condition,body_part,varargin_table)
%IBS_COMPUTE_CORRESP_VICON_MANIPULATED_VIDEO
%
% SYNOPSIS: derived from IBS_compute_corresp_vicon_video
%
...
video_cam=IBS_get_sub_behavior_data('manipulated_video_openpose_landmarks_manual_cleaned',Dyad_no,Sub_no,condition,raw_data_dir,varargin_table);
...
correlation_coeff = nancorr(averaged_body_data_vicon',body_data_video_cam');
